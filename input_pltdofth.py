...
#
# Purpose:
#        This is the input file for pltdofth.py   --> Plot dof vs trop height
#----------------------------------------------------------------------------------------
...
retDir = '/data1/jamesw/'+loc.lower()+'/'+gasName[0].lower()+'/' 

#------
# Files
#-----
ctlFile  = '/data1/ebaumer/'+loc.lower()+'/'+gasName[0].lower()+'/'+'x.'+gasName[0].lower()+'/'
if saveFlg:
    if len(gasName) == 1: 
