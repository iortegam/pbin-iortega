...
if loc == 'tab':
    ...
    #gasName    = ['co', 'c2h2',   'c2h6',  'ch4',   'h2co',    'hcooh', 'nh3',  'o3']             
    #ver        = ['Current_v3', 'Current_v2', 'Current_v2',   'Current_WP',        'Current_WP_v6',      'Current_v1', 'Current_v2',  'Current_WP']          # Name of retrieval version to process
    #ctlF       = ['sfit4_v3.ctl',  'sfit4_v2.ctl',   'sfit4_v2.ctl',  'sfit4_3.ctl',   'sfit4_v6.ctl',   'sfit4_v1.ctl', 'sfit4_v2.ctl', 'sfit4.ctl' ] 

    gasName    = ['co', 'c2h2',   'c2h6',  'ch4',   'h2co', 'nh3']             
    ver        = ['Current_v3', 'Current_v2', 'Current_v2',   'Current_WP',    'Current_WP_v6', 'Current_v2']          # Name of retrieval version to process
    ctlF       = ['sfit4_v3.ctl',  'sfit4_v2.ctl',   'sfit4_v2.ctl',  'sfit4_3.ctl',   'sfit4_v6.ctl',  'sfit4_v2.ctl'] 
...
if loc == 'tab':
        ...
        maxRMS     = [2.0, 1.0, 1.0, 0.5, 1.0, 1.0, 1.0, 4.0]                       # Max Fit RMS to filter data. Data is filtered according to <= maxrms
        minDOF     = [0.5, 0.5, 0.5, 0.9, 0.5, 0,5, 0.4, 3.0]
...
if saveFlg:
    if len(gasName) == 1: 
        pltFile  = '/data/iortega/results/'+loc.lower()+'/fig/'+loc.lower()+ '_'+ gasName[0] +'_errors_'+str(iyear)+'.pdf'
        
    else:
        pltFile  = '/data/iortega/results/'+loc.lower()+'/fig/'+loc.lower()+ '_'+'errors_'+str(iyear)+'.pdf'
