...
def main():
    ...
    #----------------
    statstr     = 'mlo'
    dataDir     = '/data1/ancillary_data/sondes/'+statstr.lower()+'/'
    ...
    #--------------------------------------
        ...
        for indvDay in daysYear:
            ...
            if (statstr.lower() == 'mlo'):
            	srchstr = 'HIH_H2O_'+yrstr+mnthstr+daystr+'.txt'
            elif (statstr.lower() == 'tab'):
            	srchstr = 'BLD_H2O_'+yrstr+mnthstr+daystr+'.txt'
           
            #------------------------
            # Look for house log file
            #------------------------
            sondefile = glob.glob( dataDir + srchstr )
            #print sondefile
