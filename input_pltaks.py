...
#----------------------------
pCols = [[0.0,8.0],[8.0,16.0],[16.0,25.0],[25.0,40.0]]
# Directories
#------------ -
...
if saveFlg:
    if len(gasName) == 1: 
        pltFile  = '/data/iortega/results/'+loc.lower()+'/fig/'+loc.lower()+ '_'+ gasName[0] +'_Aks_'+str(iyear)+'.pdf'
    else:
        pltFile  = '/data/iortega/results/'+loc.lower()+'/fig/'+loc.lower()+'_Aks_'+str(iyear)+'.pdf'
else:
    pltFile  = ''