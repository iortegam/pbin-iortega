...
class OpusIO():
    ...
    def startWatchDog(self,TO="30"):
        self.proc = psutil.Popen(["python",r"C:\bin\opusWatch.py",TO])
        return True
    ...
    def startIOwatch(self):
        ...
        while True:
            ...
            if scnFlg[0].upper() == "QUIT":
                ...
                sleep(5)
                print "No scan specified...at {}".format(dt.datetime.utcnow())
                continue
            ...
            #---------------------------------
            print "\n\nRecieved scan command from TCP server...at {}".format(dt.datetime.utcnow())
            print "Checking PIPE connection to OPUS........"
            try: 
                self.startWatchDog("30")
                self.op.ckPIPE()
                self.stopWatchDog()
            except:
                self.stopWatchDog()
            ...
            try:
                print "Initiating Macro........................at {}".format(dt.datetime.utcnow())
                self.startWatchDog("40")
            ...
            try:
                ...
                self.startWatchDog(waitTimeStr)          
            ...
            #--------------------------------------------------------------
            print "Sending OPUS return data to TCP server....."
            opusRtnVals.pop(1)
